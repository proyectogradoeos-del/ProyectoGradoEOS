...
class EosVisionScore(models.Model):
    ...
    # ---------------------------------------------------------------
    score_core_values = fields.Integer(
    ...
    score_marketing = fields.Integer(
    ...
    def _compute_scores(self):
        ...
        for record in self:
            total = (
                record.score_core_values
                + record.score_core_focus
                + record.score_10_year
                + record.score_marketing
                + record.score_3_year
                + record.score_1_year
                + record.score_rocks
                + record.score_issues
